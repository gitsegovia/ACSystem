...
const DataGridList = ({ dataFilter }: { dataFilter: Attendance[] }) => {
    return <DataGrid autoHeight rows={dataFilter} columns={columns} disableRowSelectionOnClick hideFooterPagination={true} sx={{ "& .MuiDataGrid-columnHeaders": { borderRadius: 0 } }} />
}
