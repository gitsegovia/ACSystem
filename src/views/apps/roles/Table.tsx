...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    headerName: "Status",
    renderCell: ({ row }: CellType) => {
      return <CustomChip skin="light" size="small" label={row.status} color={userStatusObj[row.status]} sx={{ textTransform: "capitalize" }} />;
    },
  },
  {
    flex: 0.1,
...
const UserList = () => {
  ...
  useEffect(() => {
    console.log("CREAR NUEVO REGISTRO DE ROLES");
  }, [dispatch, plan, value]);
