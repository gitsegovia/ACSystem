                                    ...
                                    <TimelineContent sx={{ mt: 0 }}>
                                        ...
                                        >
                                            ...
                                            <Typography variant="body2" sx={{ color: "text.disabled" }}>
                                                {att.in && moment(`${moment().format("YYYY-MM-DD")} ${att.in}`).fromNow()}
                                            </Typography>
                                        </Box>
                                        ...
                                        {att.Administrative && (
                                            <Typography sx={{ color: "text.secondary" }}>{`Administrativo: ${att.Administrative.firstName} ${att.Administrative.lastName}`}</Typography>
                                        )}
                                    </TimelineContent>
                                </TimelineItem>
                            )
                            ...
                            <TimelineItem key={att.id}>
                                ...
                                <TimelineContent sx={{ mt: 0, mb: (theme) => `${theme.spacing(2)} !important` }}>
                                    ...
                                    >
                                        ...
                                        {att.out && (
                                            <Typography variant="body2" sx={{ color: "text.disabled" }}>
                                                {moment(`${moment().format("YYYY-MM-DD")} ${att.out}`).fromNow()}
                                            </Typography>
                                        )}
                                    </Box>
                                    {att.Teacher && <Typography sx={{ color: "text.secondary" }}>{`Profesor: ${att.Teacher.firstName} ${att.Teacher.lastName}`}</Typography>}
